...
export function renderSearchFormBlock(dateEntry: Date, dateDeparture: Date) {
...
<!--            <input id="check-in-date" type="date" value="02.02.2022" min="2021-05-11" max="2021-06-30" name="checkin" />-->
